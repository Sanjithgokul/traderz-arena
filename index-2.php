...
<head>
    ...
    <link rel="preload stylesheet" as="style" type="text/css" href="/css/newTheme.css">
...
<body data-bs-spy="scroll" data-bs-target="#navbar-example">
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center reverse">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        ...
                        <p class="text-gray lh-2 text-justify"> We prioritize transparency and trust in all interactions
                            with clients. Invest with confidence with less risk assured. Say goodbye to fake calls and
                            financial losses.</p>

                        <!-- About section celeberation column -->
                                ...
                                <div class="exp-section-even back-clr back-clr-1  d-flex">
                                    <div class="cele-img cele-img-even">
                                        <img width="100%" height="100%" loading="lazy"
                                            src="./images/years-cel-green.svg" title="traderz-arena"
                                            alt="traderz-arena">
                                    </div>
                                    <div class="year-content">
                                        <h4>15+ Mentorship</h4>
    ...
    <section id="course-sec" class="section-3 box-backround-1">
        <div class="course-details">
            ...
            <div class=" mt-5">
                <div class="container">
                    <div class="courses-details">
                        <!-- First Box -->
                        <div class="box-inner">
                            <div class="course-container first-container">
                                <!-- <div class="course-details-inner"> -->
                                <div class="box-heading clr-2">
                                    <h3 class="top-heading text-center text-white d-flex">Expert Trading Course
                                    </h3>
                                    <div class="span-sec">
                                        <h4 class="m d-flex mb-2 text-white"><b class="px-2">Duration:</b> 3
                                            Months </h4>
                                        <h4 class="r d-flex text-white"> <b class="px-2">Fee: </b> 100,000 INR +
                                            GST</h4>
                                    </div>
                                </div>
                                <div class="ul-section">
                                    <ul class="course-list">
                                        <li class=" "> <img src="./images/complete-icon-blue.svg"
                                                alt="complete-icon">Stock Market Basics</li>
                                        <li class=''> <img src="./images/complete-icon-blue.svg" alt="complete-icon">
                                            Options Trading and Strategies</li>
                                        <li class=''> <img src="./images/complete-icon-blue.svg"
                                                alt="complete-icon">Advance Techniques & Adjustments</li>
                                        <li class=''> <img src="./images/complete-icon-blue.svg"
                                                alt="complete-icon">Mirror Trading</li>
                                        <li class=''> <img src="./images/complete-icon-blue.svg" alt="complete-icon">3
                                            Months Support</li>
                                    </ul>
                                </div>
                                <!-- </div> -->
                            ...
                            <div class="course-btn course-btn-2 d-flex">
                                <a data-bs-toggle="modal" data-bs-target="#staticBackdrop" href="#"
                                    class="course-btn-arrow-1"> <img src="./images/arrow-right.svg"
                                        alt="arrow-icon"></a>
                            </div>
                        </div>
                        ...
                        <!-- Second Box -->
                        <div class="box-inner">
                            <div class="course-container second-container">
                                <!-- <div class="course-details-inner"> -->
                                <div class="box-heading clr-3">
                                    <h3 class="top-heading text-center text-white d-flex">Options Trading
                                    </h3>
                                    <div class="span-sec">
                                        <h4 class="m d-flex mb-2 text-white"><b class="px-2">Duration:</b> 1 Month
                                        </h4>
                                        <h4 class="r d-flex text-white"> <b class="px-2">Fee:</b> 50,000 INR + GST
                                        </h4>
                                    </div>
                                </div>
                                <div class="ul-section">
                                    <ul class="course-list">
                                        <li class=""> <img src="./images/complete-icon-red.svg"
                                                alt="complete-icon">Candle Stick Patterns</li>
                                        <li class=''> <img src="./images/complete-icon-red.svg"
                                                alt="complete-icon">Chart Patterns</li>
                                        <li class=''> <img src="./images/complete-icon-red.svg" alt="complete-icon">Time
                                            Frame Analysis</li>
                                        <li class=''> <img src="./images/complete-icon-red.svg" alt="complete-icon">Gap
                                            up & Gap Down Trading</li>
                                        <li class=''> <img src="./images/complete-icon-red.svg"
                                                alt="complete-icon">Trade Setup</li>
                                        <li class=''> <img src="./images/complete-icon-red.svg"
                                                alt="complete-icon">Monthly Income Generation</li>
                                        <li class=''> <img src="./images/complete-icon-red.svg" alt="complete-icon">1
                                            Month Support</li>
                                    </ul>
                                </div>
                                <!-- </div> -->
                            ...
                            <div class="course-btn course-btn-3 d-flex">
                                <a data-bs-toggle="modal" data-bs-target="#staticBackdrop" href="#"
                                    class="course-btn-arrow-2"> <img src="./images/arrow-right.svg"
                                        alt="arrow-icon"></a>
                            </div>
                        </div>
                        ...
                        <!-- Third Box -->
                        <div class="box-inner">
                            <div class="course-container third-container">
                                <!-- <div class="course-details-inner"> -->
                                <div class="box-heading clr-4">
                                    <h3 class="top-heading text-center text-white d-flex">Index Trading
                                    </h3>
                                    <div class="span-sec">
                                        <h4 class="m d-flex mb-2 text-white"><b class="px-2">Duration:</b> 2 Weeks
                                        </h4>
                                        <h4 class="r d-flex text-white"> <b class="px-2">Fee:</b> 25,000 INR + GST
                                        </h4>
                                    </div>
                                </div>
                                <div class="ul-section">
                                    <ul class="course-list">
                                        <li class=""> <img src="./images/complete-icon-darkblue.svg"
                                                alt="complete-icon">Positional Expiry Trading Concepts</li>
                                        <li class=''> <img src="./images/complete-icon-darkblue.svg"
                                                alt="complete-icon">Weekly Expiry Trading Techniques</li>
                                        <li class=''> <img src="./images/complete-icon-darkblue.svg"
                                                alt="complete-icon">Intraday/Positional OI analysis</li>
                                        <li class=''> <img src="./images/complete-icon-darkblue.svg"
                                                alt="complete-icon">Index Intraday Trading</li>
                                        <li class=''> <img src="./images/complete-icon-darkblue.svg"
                                                alt="complete-icon">Intraday Adjustment Concepts</li>
                                        <!-- <li>Intraday PalysisCR An</li> -->
                                        <li class=''> <img src="./images/complete-icon-darkblue.svg"
                                                alt="complete-icon">1 Month Support</li>
                                    </ul>
                                </div>
                                <!-- </div> -->
                            </div>
                            <div class="course-btn course-btn-4 d-flex">
                                <a data-bs-toggle="modal" data-bs-target="#staticBackdrop" href="#"
                                    class="course-btn-arrow-3"> <img src="./images/arrow-right.svg"
                                        alt="arrow-icon"></a>
                            </div>
                        </div>
                        ...
                        <!-- Fourth Box -->
                        <div class="box-inner">
                            <div class="course-container forth-container">
                                <!-- <div class="course-details-inner"> -->
                                <div class="box-heading clr-5">
                                    <h3 class="top-heading text-center text-white d-flex">Mentorship Program
                                    </h3>
                                    <div class="span-sec">
                                        <h4 class="m d-flex mb-2 text-white"><b class="px-2">Duration:</b> 6 Months
                                        </h4>
                                        <h4 class="r d-flex text-white"> <b class="px-2">Fee:</b> 500,000 INR</h4>
                                        </h4>
                                    </div>
                                </div>
                                <div class="ul-section pb-2">
                                    <ul class="course-list">
                                        <li class=""> <img src="./images/complete-icon-pink.svg"
                                                alt="complete-icon">Complete A 2 Z Trading Concepts</li>
                                        <li class=''> <img src="./images/complete-icon-pink.svg" alt="complete-icon">How
                                            to Build a portfolio</li>
                                        <li class=''> <img src="./images/complete-icon-pink.svg"
                                                alt="complete-icon">Passive Income Creation</li>
                                        <li class=''> <img src="./images/complete-icon-pink.svg"
                                                alt="complete-icon">Wealth Creation</li>
                                        <li class=''> <img src="./images/complete-icon-pink.svg"
                                                alt="complete-icon">Taxation</li>
                                        <li class=''> <img src="./images/complete-icon-pink.svg"
                                                alt="complete-icon">Mirror Trading</li>
                                        <li class=''> <img src="./images/complete-icon-pink.svg" alt="complete-icon">6
                                            Months Support</li>
                                    </ul>
                                </div>
                                <!-- </div> -->
                            </div>
                            <div class="course-btn course-btn-5 d-flex">
                                <a data-bs-toggle="modal" data-bs-target="#staticBackdrop" href="#"
                                    class="course-btn-arrow-4"> <img src="./images/arrow-right.svg"
                                        alt="arrow-icon"></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="notes-container">
                <span class="course-span text-center mt-5"> <b>Note:</b> For all courses we guarantee you the payback
                ...
                <div class="row justify-content-center align-items-center reverse">
                    <div class="col-12 col-md-12 col-lg-7">
                        ...
                        <p class="text-gray lh-2 text-justify">A trailblazing entrepreneur who has unlocked the secrets
                            ...
                            trader. He doubles investments in 3-4 years, surpassing market expectations. As a trader cum
                            trainer, Deepak is a beacon of knowledge, empowering aspiring traders with his insights and
                            expertise. In 2021, he founded Traderz Arena LLP, a platform where he continues to inspire
                            and educate, reshaping financial markets.</p>
    ...
    <section class="testimonial-section">
        <div class="carousel-container">
            <!-- Testimonial-heading -->
            <div class="col-12 col-md-12 col-lg-12 title-box">
                <h2 class="heading text-bold text-gray text-center t-1">Our Testimonials</h2>
                <p class="top-heading text-center text-black d-flex t-2">What they’re talking about us</p>
            </div>
                        ...
                        <div class="carousel-slider">
                            <div class="carousel-details-container">
                                <div class="carousel-header">
                                    <img src="../images/quotation-carousel.svg" alt="quotes">
                                </div>

                                <div class="carousel-info">
                                    <div class="carousel-user-name">
                                        <p>V.Anbarasu</p>
                                    </div>
                                    <div class="carousel-user-role">
                                        <p></p>
                                    </div>
                            ...
                            <div class="carousel-profile">
                                <img src="../images/client-img-new.svg" alt="Person">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item">
                        <div class="carousel-slider">
                            <div class="carousel-details-container">
                                ...
                                <div class="carousel-info">
                                    <div class="carousel-user-name">
                                        <p>Poorani Anbarasu</p>
                                    </div>
                                    <div class="carousel-user-role">
                                        <p>Adetprite Solutions</p>
                                    </div>
                                    <div class="carousel-rating">
                                        <ul class="star m-0">
                                            <li><img class="ratingStar" loading="lazy" src="./images/yellow-star.svg"
                                ...
                                <div class="carousel-details">
                                    ...
                                    <p class="text-justify">Deepak K L's stock trading training sessions have been a game-changer for my
                            ...
                            <div class="carousel-profile">
                                <img src="../images/client-profile-2.svg" alt="Person">
                            </div>
                        </div>
                    </div>
