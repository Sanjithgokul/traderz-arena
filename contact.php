            ...
            <div class="container">
                <nav class="navbar navbar-expand-sm">
                    <div class="container-fluid backround">
                      <a class="navbar-brand" href="#"><img width="100%" height="100%" loading="lazy" src="./images/traderz-arena.svg" title="Traderz-arena-logo" alt="Traderz-arena"></a>
        ...
        <div class="container">
            <div class="row d-flex">
                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <iframe
                        src="https://www.google.com/maps/d/u/0/embed?mid=1tuiFLc565JOpHWaYt9wWtpYvXwLTbeZe"
                        width="100%" height="450" frameborder="0" style="border:0" allowfullscreen
                        title="Soft Suave Address">
                    </iframe>
                </div>
            </div>
        </div>
