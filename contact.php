                    ...
                    <div class="contact-left">
                        ...
                        <div class="contact-email">
                            ...
                            <ul class="foooter-social-icon">
                                <li> <a href="#"><img width="30" height="30" loading="lazy" src="./images/facebook-contact.svg"  title="traderz-arena-facebook" alt="traderz-arena"></a></li>
                                <li> <a href="#"><img width="30" height="30" loading="lazy" src="./images/twitter-contact.svg"  title="traderz-arena-twitter" alt="traderz-arena"></a></li>
                                <li> <a href="#"><img width="30" height="30" loading="lazy" src="./images/youtube-contact.svg" title="traderz-arena-youtube"  alt="traderz-arena"></a></li>
