    ...
    <script type="application/ld+json">
        {
            ...
            "sameAs": [
                "https://www.facebook.com/profile.php?id=100093842165629",
                        ...
                        <div class="row year">
                            <div class="col-6 col-md-6 col-lg-6 mb-4">
                                <div class="back-clr  back-clr-1 d-flex" style="justify-content:flex-start;">
                                    <div class="cele-img">
                                        <img width="100%" height="100%" loading="lazy" src="./images/year-123.svg"
                        ...
                        <div class="col-12 col-md-6 col-lg-4 box-1 d-flex mb-5">
                            <div class="box-inner">
                                <div class="box-heading clr-2 mb-3">
                                    ...
                                    <div class="span-sec">
                                        <h4 class="m d-flex mb-2 text-white"><b class="px-2">Duration:</b> 3 Months
                                        </h4>
                                        <h4 class="r d-flex text-white"> <b class="px-2">Fee: </b> 100,000 INR + GST
                                        </h4>
                                    </div>
                                </div>
